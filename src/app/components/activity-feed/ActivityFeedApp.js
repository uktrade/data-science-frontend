...
(function (_React$Component) {
  ...
  (0, _createClass2.default)(ActivityFeedApp, [{
    ...
    value: function render () {
      ...
      var activities = _this$state2.activities
      var isLoading = _this$state2.isLoading
      var hasMore = _this$state2.hasMore
      var total = _this$state2.total
      var error = _this$state2.error
      var _this$props2 = this.props
      var addContentText = _this$props2.addContentText
      var addContentLink = _this$props2.addContentLink
      var render = _this$props2.render
